...
const Client = () => {
  return (
   ...
   <img className="absolute top-[720px] left-[750px]" src="./assets/Uber Eats Logo.png" alt=""/>
   <img className="absolute top-[720px] left-[850px]" src="./assets/Amazon Logo.png" alt=""/>
